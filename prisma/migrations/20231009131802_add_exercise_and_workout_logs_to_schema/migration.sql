/*
  ...
  - You are about to drop the column `logId` on the `Workout` table. All the data in the column will be lost.
  - You are about to drop the `Log` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "Workout" DROP CONSTRAINT "Workout_logId_fkey";

-- AlterTable
ALTER TABLE "Exercise" ADD COLUMN     "exerciseLogId" INTEGER;

-- AlterTable
ALTER TABLE "Workout" DROP COLUMN "logId";
